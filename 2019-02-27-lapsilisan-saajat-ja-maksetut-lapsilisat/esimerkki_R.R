...
# rmarkdown::render(input = "./2019-02-27-lapsilisan-saajat-ja-maksetut-lapsilisat/esimerkki_R.R", output_file = "./esimerkki_R.md")
...
x <- package_search(q = "Kansaneläkelaitos", fq = "title:lapsilisä")
tibble(
...
#+ setup
ckanr_setup(url = "https://www.betaavoindata.fi/data/fi/")
x <- package_search(q = "Kansaneläkelaitos", fq = "title:lapsilisän")
...
ggplot(df2, aes(x = `Väkiluvun muutos edellisestä vuodesta, %, 2018`, 
                y = lapsilisat_euroa_perhe, 
                size = `Väkiluku, 2018`)) + 
  geom_point(alpha = .3) +
