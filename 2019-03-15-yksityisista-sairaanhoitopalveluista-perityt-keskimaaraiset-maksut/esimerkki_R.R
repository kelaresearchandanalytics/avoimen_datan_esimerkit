...
# rmarkdown::render(input = "./2019-03-15-yksityisista-sairaanhoitopalveluista-perityt-keskimaaraiset-maksut/esimerkki_R.R", output_file = "./esimerkki_R.md")
...
x <- package_search(q = "Kansaneläkelaitos", fq = "title:yksityisistä")
tibble(
