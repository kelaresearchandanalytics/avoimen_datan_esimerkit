...
# rmarkdown::render(input = "./2019-02-19-kelan-yleisen-asumistuen-saajat/esimerkki_R.R",  output_file = "./esimerkki_R.md")
...
ggplot(df2, 
       aes(x = `Vuokra-asunnoissa asuvien asuntokuntien osuus, %, 2018`, 
