...
# rmarkdown::render(input = "./2019-02-27-lastenhoidon-tukien-saajat-ja-maksetut-tuet/esimerkki_R.R", output_file = "./esimerkki_R.md")
...
ggplot(df2, aes(x = `Alkutuotannon työpaikkojen osuus, %, 2017`, 
